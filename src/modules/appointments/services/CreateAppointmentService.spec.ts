...
import FakeNotificationsRepositories from '@modules/notifications/repositories/fakes/FakeNotificationsRepositories';
...
describe('CreateAppointment', () => {
  ...
  it('should not be able to create two appointments on the same time', async () => {
    const appointmentDate = new Date(2020, 8, 16, 10);
